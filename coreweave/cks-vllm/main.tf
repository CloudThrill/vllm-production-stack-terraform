...
#  Part of the CloudThrill implementation contribution to the VLLM commmunity.
...
resource "kubectl_manifest" "nodepool_cpu" {
  ...
  yaml_body = templatefile("${path.module}/config/manifests/nodepool-cpu.yaml",
    {
...
yaml_body = templatefile(
    "${path.module}/config/manifests/nodepool-gpu.yaml",
    {
