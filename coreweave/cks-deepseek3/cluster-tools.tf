...
#################################################################################
# test CPU nodepool is ready - terraform_data with local-exec provisioner
################################################################################
...
#####################################
# 5) CPU Nodepool Ready Proof Data
#####################################

# resource "terraform_data" "cpu_nodes_ready_proof" {
#   depends_on = [
#     terraform_data.wait_for_cpu_nodes
#   ]

#   input = {
#     message = "CPU node pool is Ready — barrier passed"
#     ready   = true
#   }
# }

# output "cpu_nodepool_ready" {
#   value = terraform_data.cpu_nodes_ready_proof.input
# }
