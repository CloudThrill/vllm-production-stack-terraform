...
variable "letsencrypt_email" {
  type    = string
  default =  "admin@gmail.com"  # "admin@example.com"  #  forbidden domain "example.com"
    validation {
...
variable "gpu_vllm_helm_config" {
  ...
  type        = string
  default     = "config/llm-stack/helm/gpu/gpu-deepseek-v32.tpl"
  # "This is the required chart to deploy deepseek-v32"
